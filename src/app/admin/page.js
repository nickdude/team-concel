            ...
            <div className="max-w-7xl mx-auto p-6">
                ...
                <div className="grid grid-cols-2 gap-8">
                    ...
                    <Link href="/admin/image-manager">
                        <div className="bg-white rounded-2xl shadow-around border border-brand.grayish p-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 cursor-pointer">
                            <div className="flex items-center mb-4">
                            ...
                            <p className="text-brand.darkBlueAlpha leading-relaxed">
                                Upload, organize, and manage all website images. Replace existing images or add new ones with drag & drop.
                            </p>
                        </div>
                    </Link>
