...
const siteData = {
    homePage: {
        hero: {
            ...
            description:
                "Cut through legal complexity with a startup-native approach that’s fast, compliant, and built for scale. ",
            ...
            cards: [
                {
                    ...
                    description:
                        "High-quality legal services are often priced out of reach for early-stage startups.",
                },
                {
                    image: "/assets/why2.svg",
                    label: "Inflexible Solutions",
                    description:
                        "Generic contracts and rigid service models don't adapt to fast-changing startup needs.",
                },
                {
                    image: "/assets/why3.svg",
                    label: "Reactive Legal Support",
                    description:
                        "Legal help often arrives too late. Startups need legal partners from Day 1.",
                },
            ],
        },
        uspSection: {
            ...
            cards: [
                {
                    ...
                    description:
                        "Investor-ready, compliance-ready, customer-ready frameworks so you never get caught off-guard.",
                },
                {
                    image: "/assets/solution2.svg",
                    label: "Fractional General Counsel",
                    description:
                        "Your plug-and-play legal partner — strategy + day-to-day queries without the $200K price tag.",
                },
                {
                    image: "/assets/solution3.svg",
                    label: "Contract Solutions",
                    description:
                        "Contracts that don’t kill deals. Standardized, fast, and startup-native.",
                },
            ],
        },
        processSection: {
    ...
    practicePage: {
        hero: {
            ...
            description:
                "From incorporation to fundraising, contracts to compliance — we’re the legal partner founders trust when every move matters.",
    ...
    legalDesignAndTransformationPage: {
        hero: {
            ...
            description:
                "Legal design isn’t theory—it’s about reshaping your contracts, processes, and tools so they actually work for fast-moving businesses. We help you cut complexity, stay compliant, and build a legal backbone that scales with you.",
            buttonLabel: "Book Free Consultation"
        },
        tagCardSection: {
            header: {
    ...
    caasPage: {
        hero: {
            label: "Contract as a Service",
            header: {
                simple: "Your Startup’s Legal Team.",
                italic: "Without the Full-Time Cost.",
            },
            description:
                "Skip the expensive hires and inconsistent law firms. With Fractional GC, you get an on-demand legal partner who scales with you—from contracts to compliance to fundraising.",
    ...
    fractionalGcPage: {
        hero: {
            ...
            header: {
                ...
                italic: " Start Closing Faster.",
            },
            description:
                "We take contracts off your plate—from drafting to negotiation to renewals—so you can focus on growth. Founder-friendly, investor-ready, always on time.",
